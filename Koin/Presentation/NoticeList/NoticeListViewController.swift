    ...
    private func bind() {
        ...
        noticeTableView.keyWordAddBtnTapPublisher
            ...
            .sink { [weak self] in
                ...
                let viewModel = ManageNoticeKeyWordViewModel(addNotificationKeyWordUseCase: addNotificationKeyWordUseCase, deleteNotificationKeyWordUseCase: deleteNotificationKeyWordUseCase, fetchNotificationKeyWordUseCase: fetchNotificationKeyWordUseCase, fetchRecommendedKeyWordUseCase: fetchRecommendedKeyWordUseCase)

//
//  EventOrderShopCollectionView.swift
//  koin
//
...
final class EventOrderShopCollectionView: UICollectionView, UICollectionViewDataSource, UIScrollViewDelegate, UICollectionViewDelegate  {
    
    private var eventShops: [OrderShopEvent] = []
    ...
    private func commonInit() {
        register(EventOrderShopCollectionViewCell.self, forCellWithReuseIdentifier: EventOrderShopCollectionViewCell.identifier)
        dataSource = self
        delegate = self
    ...
    func setEventShops(_ eventList: [OrderShopEvent]) {
...
extension EventOrderShopCollectionView {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: EventOrderShopCollectionViewCell.identifier, for: indexPath) as? EventOrderShopCollectionViewCell else {

        ...
        input.sink { [weak self] input in
            ...
            case .viewDidLoad:
                ...
                self?.outputSubject.send(.updateMenus([
                    OrderShopMenus(menuGroupID: 0, menuGroupName: "메인메뉴", menus: [
                    ...
                    OrderShopMenus(menuGroupID: 1, menuGroupName: "추천메뉴", menus: [
                    ...
                    OrderShopMenus(menuGroupID: 1, menuGroupName: "세트메뉴", menus: [
                    ...
                    OrderShopMenus(menuGroupID: 1, menuGroupName: "사이드", menus: [

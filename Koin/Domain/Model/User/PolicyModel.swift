...
extension PolicyType {
    var displayName: String {
        switch self {
        case .personalInformation: return "개인정보 이용약관"
        case .koin: return "코인 이용약관"
        }
    }
    
    var navigationTitle: String {
        switch self {
        case .personalInformation: return "개인정보 처리방침"
        case .koin: return "코인 이용약관"
        }
    }
}
...
final class PolicyModel {
    ...
    static let shared = PolicyModel()
    
    func getPolicyTexts(for type: PolicyType) -> [PolicyText] {
        switch type {
        case .personalInformation:
            return personalInformationPolicies
        case .koin:
            return koinPolicies
        }
    }
    
    private let personalInformationPolicies: [PolicyText] = [
        PolicyText(title: "개인정보의 처리 목적", content: """
(‘koreatech.in’이하 ‘코인’) 은(는) 다음의 목적을 위하여 개인정보를
                   처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
                   고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인식별.
                   인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제,
                   물품 또는 서비스의 공급.배송 등)
"""),
        PolicyText(title: "개인정보의 처리 및 보유 기간", content: """
                   ①(‘koreatech.in’이하 ‘코인’) 은(는) 정보주체로부터 개인정보를 수집할
때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․
...
"""),
        PolicyText(title: "개인정보의 제3자 제공", content: """
                  (‘koreatech.in’이하 ‘코인) 은(는) 정보주체의 별도 동의, 법률의
                  특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우 외에는
                  개인정보를 제3자에게 제공하지 않습니다.
        """),
        PolicyText(title: "처리하는 개인정보의 항목 작성", content: """
                   ① ('koreatech.in'이하 '코인')은(는) 다음의 개인정보 항목을 처리하고 있습니다.  1<일반 회원가입> 필수항목 : 이메일, 로그인ID, 이름, 닉네임, 학번, 학부, 학년 선택항목 : 휴대전화번호, 성별, 소속 동아리, 소속 자치지구, 졸업여부 2<자동 수집 항목> 필수항목 : 서비스 이용 기록, 접속 로그, 접속 IP 정보
                """),
        PolicyText(title: "개인정보의 파기", content: """
                   ('코인')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은  다음과 같습니다. -파기절차이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다. 이 때, DB로  옮겨진 개인정보는 법률에 의한 경우가 아니고서는 다른 목적으로 이용되지 않습니다.-파기기한이용자의 개인정보는 개인정보의
                   보유기간이 경과된 경우에는 보유기간의 종료일로부터 5일 이내에, 개인정보의 처리 목적 달성, 해당 서비스의 폐지, 서비스의 종료 등 그 개인정보가 불필요하게 되었을 때에는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 5일 이내에 그 개인정보를 파기합니다.
        """),
        PolicyText(title: "개인정보의 안전성 확보 조치", content: """
                   ('코인')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다. 내부관리계획의 수립 및 시행 개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고
                   있습니다. 개인정보의 암호화 이용자의 개인정보는 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다. 개인정보에 대한 접근 제한 개인정보를 처리하는 데이터베이스 시스템에 대한 접근권한의 부여,변경,말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며 침입차단 시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.
                """),
        PolicyText(title: "개인정보 보호책임자 작성", content: """
                   ① BCSD Lab(‘koreatech.in’이하 ‘코인) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다. ▶ 개인정보 보호책임자 성명 : 최원빈 (BCSD Lab Project Leader) 연락처 : chldnjsqls1264@gmail.com ※ 개인정보 보호 담당부서로 연결됩니다.
...
"""),
        PolicyText(title: "서비스의 제공 및 변경", content: """
...
"""),
        PolicyText(title: "서비스의 중단", content: """
...
"""),
        PolicyText(title: "회원 탈퇴 및 자격 상실 등", content: """
...
"""),
        PolicyText(title: "회원에 대한 통지", content: """
...
"""),
        PolicyText(title: "회원의 ID 및 비밀번호에 대한 의무", content: """
...
"""),
        PolicyText(title: "회원의 의무", content: """
...
"""),
        PolicyText(title: "공개게시물의 삭제 또는 이용제한", content: """
...
"""),
        PolicyText(title: "저작권의 귀속 및 게시물의 이용", content: """
...
"""),
        PolicyText(title: "광고게재 및 광고주와의 거래", content: """
...
"""),
        PolicyText(title: "약관의 개정", content: """

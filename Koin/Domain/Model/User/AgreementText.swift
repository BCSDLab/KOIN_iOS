...
extension AgreementText {
    var description: String {
        ...
        case .personalInformation:
            return """
제1조 개인정보의 처리 목적 (‘koreatech.in’이하 ‘코인’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
...
"""
        ...
        case .marketing: return
            ...
            - 뉴스레터 발송, 신규 기능 안내 및 홍보, 맞춤형 서비스 및 기능 추천, 사용자 경험 개선을 위한 신규 기능 개발 및 이벤트 안내 등제
            ...
            제4조 보유 및 활용기간
            - 마케팅 활용 동의일로부터 회원 탈퇴 또는 동의철회 시까지* 본 동의 약관은 선택사항이며, 동의하지 않아도 코인('koreatech.in'이하 'KOIN') 어플의 기본 서비스 이용에는 아무런 제한이 없습니다.
            - 마케팅 정보 수신 동의/해제는 어플의 설정 메뉴에서 변경하실 수 있습니다.
            """
        }
    }
}

...
struct CarouselView: View {
            ...
            VStack{
                ...
                ZStack{
                    ForEach(0..<views.count){i in
                        VStack{
                            self.views[i]
                                .frame(width:265, height: self.getHeight(i))
                                .animation(.interpolatingSpring(stiffness: 265.0, damping: 30.0, initialVelocity: 10.0))
    ...
    func getOffset(_ i:Int) -> CGFloat{
        ...
        {
            //Set offset +1
            return self.dragState.translation.width + (265 + 8)
        }
        else if
            (i) == relativeLoc() - 1
                ||
        ...
        {
            return self.dragState.translation.width + (2*(265 + 8))
        }
        else if
            (i) == relativeLoc() - 2
                ||
        ...
        {
            return self.dragState.translation.width + (3*(265 + 8))
        }
        else if
            (i) == relativeLoc() - 3
                ||

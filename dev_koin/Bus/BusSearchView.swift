...
class BusSearchController: UIViewController {
    ...
    @IBOutlet var currentDateText: UILabel!
    ...
    @IBAction func selectDepart(_ sender: UIButton) {
    ...
    @IBAction func selectArrival(_ sender: UIButton) {
    ...
    override func viewDidLoad() {
        ...
        currentDateFormatter.locale = Locale.current
         currentDateFormatter.dateFormat = "MM월 dd일 (EEEEE)"
        
        
         currentDateText.text = currentDateFormatter.string(from: Date())
        ...
        let ok = UIAlertAction(title: "확인", style: .default) { (action) in
            ...
            self.currentDateText.text = currentDateFormatter.string(from: self.picker.date)
        }
        alert.addAction(ok)
